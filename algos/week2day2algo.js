...
function findByIdAndUpdate(id, updatedVals, collection) {
    //need to find POSITION of student in array, not just id
    let student = collection.find(x => x.id === id);
    let i = student.id;
    // student.isLateToday = updatedVals.isLateToday;
    // console.log(student);

    // const updated = {...student[0],...updatedVals};
